...
bool ThreePlaneIntersect(Plane a, Plane b, Plane c, Vector3 *v) {
	...
	Vector3 tA = Vector3Scale(Vector3CrossProduct(b.normal, c.normal), a.distance);
	Vector3 tB = Vector3Scale(Vector3CrossProduct(c.normal, a.normal), b.distance);
	Vector3 tC = Vector3Scale(Vector3CrossProduct(a.normal, b.normal), c.distance);
